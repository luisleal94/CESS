...
function AgregaRec(){
  ...
  row.insertCell(1).innerHTML= '<input type="text" class="texto2" id=id'+rowCount+'1 name=idM'+rowCount+'1 >'; //myName.value;
  row.insertCell(2).innerHTML= '<input type="text" class="texto2" id=id'+rowCount+'2 name=idM'+rowCount+'2 >';
  row.insertCell(3).innerHTML= '<input type="text" class="texto2" id=id'+rowCount+'3 name=idM'+rowCount+'3 >';
  row.insertCell(4).innerHTML= '<input type="text" class="texto2" id=id'+rowCount+'4 name=idM'+rowCount+'4 >';
  row.insertCell(5).innerHTML= '<input type="text" class="texto2" id=id'+rowCount+'5 name=idM'+rowCount+'5 >';
  row.insertCell(6).innerHTML= '<input type="text" class="texto2" id=id'+rowCount+'6 name=idM'+rowCount+'6 >';
  row.insertCell(7).innerHTML= '<input type="text" class="texto2" id=id'+rowCount+'7 name=idM'+rowCount+'7 >';
  row.insertCell(8).innerHTML= '<input type="text" class="texto2" id=id'+rowCount+'8 name=idM'+rowCount+'8 >';
  row.insertCell(9).innerHTML= '<input type="text" class="texto2" id=id'+rowCount+'9 name=idM'+rowCount+'9 >';
