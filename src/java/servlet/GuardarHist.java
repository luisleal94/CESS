                ...
                if(toma.equals("No")&&fuma.equals("No")&&relacion.equals("No")){
                    if(cirujia.equals("No")&&alergia.equals("No")&&diabetes.equals("No")&&hiper.equals("No")){                        
                            ...
                            if(new Consulta().historial_NoPato(aseo, bucal, ropa, leche,carne, verdura, legumbre, cereal, id)
                                    ...
                                    && new Consulta().ResGineco(gestas, Partos, abortos, Cesareas, CompliEmba, UltimaRe, id)
                                    ...
                                    &&new Consulta().AbueloPa(abueloP0,abueloP1,abueloP2,abueloP3,abueloP4,abueloP5,abueloP6,abueloP7,abueloP8,abueloP9,abueloP10,id,1)
                                    && new Consulta().AbueloPa(AbuelaP0,AbuelaP1,AbuelaP2,AbuelaP3,AbuelaP4,AbuelaP5,AbuelaP6,AbuelaP7,AbuelaP8,AbuelaP9,AbuelaP10,id,2)
                                    && new Consulta().AbueloPa(AbueloMa0,AbueloMa1,AbueloMa2,AbueloMa3,AbueloMa4,AbueloMa5,AbueloMa6,AbueloMa7,AbueloMa8,AbueloMa9,AbueloMa10,id,3)
                                    && new Consulta().AbueloPa(AbuelaMa1,AbuelaMa2,AbuelaMa3,AbuelaMa4,AbuelaMa5,AbuelaMa6,AbuelaMa7,AbuelaMa8,AbuelaMa9,AbuelaMa10,AbuelaMa11,id,4)
                                    && new Consulta().AbueloPa(Padre0,Padre1,Padre2,Padre3,Padre4,Padre5,Padre6,Padre7,Padre8,Padre9,Padre10,id,7)
